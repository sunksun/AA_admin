            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-" style="font-size:22px;">ออกรายงาน ศูนย์วิทยาศาสตร์เเละเทคโนโลยีสารสนเทศ มหาวิทยาลัยราชภัฏเลย(นักศึกษา)</h1>
                    </div>
                    ...
                    <div class="col-xl-12 col-lg-12">
                            <form action="officer_fpdf_student.php" method="POST">
                                <center>
