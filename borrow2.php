        ...
        <div id="content-wrapper" class="d-flex flex-column">
                                        ...
                                        <form action="" name="frmMain" id="frmMain" method="post">
										  <div class="form-row">
											<div class="form-group col-md-6">
											  <label for="inputEmail4">มีความประสงค์ขอใช้  สารเคมี  ในรายวิชา</label>
                                          ...
                                          <?php
                                            $sql_tbluser = "SELECT * FROM tbluser WHERE field = '$field';";
                                            $query_tbluser = mysqli_query($conn, $sql_tbluser);
                                          ?>
										  <div class="form-group col-md-12">
                                                    <label for="inputAddress">อาจารย์ที่ปรึกษา</label>
                                                    <select class="form-control" name="advisor" id="advisor">
                                                        <option value="" selected disabled>-เลือกอาจารย์ที่ปรึกษา-</option>
                                                        <?php foreach ($query_tbluser as $value) { ?>
										  ...
										  <div class="form-row">
											<div class="form-group col-md-4">
											  <label for="inputEmail4">ค้นหารายการสารเคมี</label>
            ...
            <script>
                function loadXMLDoc()  {
                    ...
                    xhttp.open("GET","server2.php?student_id=<?php echo $student_id ?>",true);
                    xhttp.send();
                } 
