<?php
	...
	$sql_check = "SELECT * FROM borrow WHERE borrow_id = '$borrow_id';";
	$query_check = mysqli_query($conn, $sql_check);
	$result_check = mysqli_fetch_array($query_check,MYSQLI_ASSOC);

	if($result_check["borrow_id"] == $borrow_id){
		$sql2 = "INSERT INTO borrow_list (borrow_id, equ_list, num,student_id) VALUES ('$borrow_id', '$equ_list', '$num', '$student_id'); ";
