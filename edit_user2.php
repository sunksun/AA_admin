                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">แก้ไขข้อมูลนักศึกษา</h6>
						...
						?>
                        <div class="card-body">
                            <form action="edit_user2_save.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">

                            <div class="form-group">
								<label for="fullname" class="col-form-label">คณะ:</label>
								<input type="text" class="form-control" name="faculty" value="<?php echo $row["faculty"]; ?>">
							  </div>
                            <div class="form-group">
								<label for="fullname" class="col-form-label">สาขาวิชา:</label>
								<input type="text" class="form-control" name="field" value="<?php echo $row["field"]; ?>">
							  </div>
                              <div class="form-group">
								<label for="fullname" class="col-form-label">หมู่เรียน :</label>
								<input type="text" class="form-control" name="sec" value="<?php echo $row["sec"]; ?>">
							  </div>
                              <div class="form-group">
								<label for="fullname" class="col-form-label">รหัสนักศึกษา :</label>
								<input type="text" class="form-control" name="student_id" value="<?php echo $row["student_id"]; ?>">
							  </div>
							  <div class="form-group">
								<label for="fullname" class="col-form-label">ชื่อ-นามสกุล :</label>
								<input type="text" class="form-control" name="name_n" value="<?php echo $row["name_n"]; ?>">
							  </div>
                              <div class="form-group">
