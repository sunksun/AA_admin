...
<div class="modal fade in" id="update_modal<?php echo $fetch['borrow_id']?>" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<form method="POST" action="officer_approve_return_save2.php?borrow_id=<?php echo $fetch['borrow_id']?>">
				...
				<div class="modal-body">
					<div class="col-md-12">
						...
						<?php
							$query2 = mysqli_query($conn, "SELECT * FROM borrow_list2 WHERE borrow_id = '$fetch[borrow_id]';") or die(mysqli_error($conn));
							$i = 1;
				...
				<div class="modal-footer">
					<button name="update" class="btn btn-warning">อนุมัติการคืน</button>
