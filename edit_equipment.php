                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">แก้ไขข้อมูลอุปกรณ์</h6>
						...
						?>
                        <div class="card-body">
                            <form action="edit_equipment_save.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">

                            <div class="form-group">
								<label for="fullname" class="col-form-label">รายการอุปกรณ์:</label>
								<input type="text" class="form-control" name="equipment_name" value="<?php echo $row["equipment_name"]; ?>">
							  </div>
                            <div class="form-group">
								<label for="fullname" class="col-form-label">class:</label>
                              ...
                              <div class="form-group">
								<label for="fullname" class="col-form-label">ราคาต่อหน่วย :</label>
