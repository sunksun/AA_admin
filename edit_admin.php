                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">แก้ไขข้อมูลผู้ดูแลระบบ</h6>
						...
						?>
                        <div class="card-body">
                            <form action="edit_admin_save.php" method="post" enctype="multipart/form-data">
							  <div class="form-group">
								<label for="fullname" class="col-form-label">ชื่อ-นามสกุล :</label>
							  ...
							  <div class="form-group">
								<label for="custaddr" class="col-form-label">ที่อยู่ :</label>
								<input type="text" class="form-control" name="custaddr" value="<?php echo $row["custaddr"]; ?>">
							  </div>
							  <div class="form-group">
								<label for="username" class="col-form-label">ชื่อผู้ใช้งาน (Username) :</label>
