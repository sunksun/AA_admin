        ...
        <div id="content-wrapper" class="d-flex flex-column">
                                        ...
                                        <form action="" name="frmMain" id="frmMain" method="post">
										  ...
										  <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2">
                                                    ...
                                                    <option value="กระบอก">กระบอก</option>
                                                    <option value="แผ่น">แผ่น</option>
                                                    <option value="นพ็ค">แพ็ค</option>
                                                    <option value="ชุด">ชุด</option>
                                                    <option value="ถาต">ถาต</option>
                                                    <option value="ตั้ง">ถัง</option>
                                                        </select>
                                                        </div>
											<div class="form-group col-md-2">
            ...
            <script>
                function loadXMLDoc()  {
                    ...
                    xhttp.open("GET","server.php?student_id=<?php echo $student_id ?>",true);
                    xhttp.send();
                } 
