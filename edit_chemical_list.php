            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
						...
						<?php
							$id = $_GET["id"];
							$sql = "SELECT * FROM chemical WHERE id = ? ";
							$stmt = $conn->prepare($sql);
						...
						?>
                        <div class="card-body">
                            <form action="edit_chemical_list_save.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">

                            <div class="form-group">
								<label for="fullname" class="col-form-label">รายชื่อสารเคมี:</label>
								<input type="text" class="form-control" name="chem_name" value="<?php echo $row["chem_name"]; ?>">
							  </div>
                            <div class="form-group">
								<label for="fullname" class="col-form-label">ปริมาณ:</label>
								<input type="text" class="form-control" name="volume" value="<?php echo $row["volume"]; ?>">
							  </div>
                              <div class="form-group">
								<label for="fullname" class="col-form-label">ดุลยภาพ :</label>
								<input type="text" class="form-control" name="balance" value="<?php echo $row["balance"]; ?>">
							  </div>
                              <div class="form-group">
								<label for="fullname" class="col-form-label">หน่วย :</label>
								<input type="text" class="form-control" name="unit" value="<?php echo $row["unit"]; ?>">
							  </div>
                              <div class="form-group">
								<label for="fullname" class="col-form-label">type :</label>
								<input type="text" class="form-control" name="typee" value="<?php echo $row["typee"]; ?>">
							  </div>
							  <div class="form-group">
