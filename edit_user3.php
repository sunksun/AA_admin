                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">แก้ไขข้อมูลอาจารย์</h6>
						...
						?>
                        <div class="card-body">
                            <form action="edit_user3_save.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
