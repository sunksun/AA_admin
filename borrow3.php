        ...
        <div id="content-wrapper" class="d-flex flex-column">
                                        ...
                                        <form action="" name="frmMain" id="frmMain" method="post">
										  <div class="form-row">
											<div class="form-group col-md-6">
											  <label for="inputEmail4">มีความประสงค์ขอใช้  อุปกรณ์ครุภัณฑ์  ในรายวิชา</label>
            ...
            <script>
                function loadXMLDoc()  {
                    ...
                    xhttp.open("GET","server3.php?student_id=<?php echo $student_id ?>",true);
                    xhttp.send();
                } 
